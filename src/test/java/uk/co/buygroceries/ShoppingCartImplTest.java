...
public class ShoppingCartImplTest {
  ...
  public void testWhen4MilkThenTotalShouldBe3Pounds45Pence() {
    ...
    double totalAmount = generateBill.generateBill(shoppingCart);
    assertEquals("test When 4 Milk, then the total amount Should be 3 Pounds 45 Pence.", 3.45D,
        totalAmount, 0.01);
  }
  ...
  public void testWhen4Butter4BreadAnd6MilkThenTotalShouldBe10Pounds8Pence() {
    ...
    double totalAmount = generateBill.generateBill(shoppingCart);
    assertEquals(
        "test When 4 Butter, 4 Bread and 6 Milk, then the total amount Should be 10 Pounds 8 Pence.",
  ...
  public void testWhen100MilkThenTotalShouldBe76Pounds66Pence() {
    ...
    double totalAmount = generateBill.generateBill(shoppingCart);
    assertEquals("test When 100 Milk then the total amount Should be 76 Pounds 66 Pence.", 76.66D,
        totalAmount, 0.55);
  }
